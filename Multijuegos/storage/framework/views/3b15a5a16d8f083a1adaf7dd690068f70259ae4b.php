                    ...
                    <?php if(Route::has('login')): ?>
                        <div class="hidden fixed top-0 right-0 px-2 py-4 sm:block">
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/multijuegos')); ?>" class="text-sm text-gray-700 underline">Multijuegos</a>
                            <?php else: ?>
...
<?php /**PATH /var/www/html/ecalvo/eric/Proyecto/Multijuegos/resources/views/welcome.blade.php ENDPATH**/ ?>